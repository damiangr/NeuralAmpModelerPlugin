...
PLUGIN_NAME=`grep "^#define BUNDLE_NAME " config.h`
PLUGIN_NAME=${PLUGIN_NAME//\#define BUNDLE_NAME }
PLUGIN_NAME=${PLUGIN_NAME//\"}
PLUGIN_NAME=$(echo "$PLUGIN_NAME" | tr -d '\r')
...
PLUG_NAME=`grep "^#define PLUG_NAME " config.h`
PLUG_NAME=${PLUG_NAME//\#define PLUG_NAME }
PLUG_NAME=${PLUG_NAME//\"}
PLUG_NAME=$(echo "$PLUG_NAME" | tr -d '\r')

ARCHIVE_NAME=$PLUG_NAME-v$FULL_VERSION-mac
